...
<body>
    ...
    if (localStorage.getItem("lc-codepen-clone-js") == null)
        jsEditor.session.setValue(`//JavaScript code`);
    else
    ...
    function update() {
        ...
        let output2 = document.querySelector(".output2 .virtual-iframe").contentWindow.document;
        console.log(output)
        output2.open();
        output2.write("<style>" + cssEditor.getValue() + "</style>" + htmlEditor.getValue() + "<script>" + jsEditor.getValue() + "</"+"script>");
        output2.close();
        localStorage.setItem("lc-codepen-clone-html", htmlEditor.getValue())
        localStorage.setItem("lc-codepen-clone-css", cssEditor.getValue())
        localStorage.setItem("lc-codepen-clone-js", jsEditor.getValue())
    ...
    let op=0;
    document.querySelector(".change-output").addEventListener("click", function () {
    ...
    function changeoutput(){
       switch(op){
        ...
        document.getElementById("out2").style.display = "";
        break;
        case 1:
